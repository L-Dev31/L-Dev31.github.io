...
import { MagnifyingGlassIcon, MapPinIcon, PlayIcon, StopIcon } from '@heroicons/react/24/outline';
      ...
      {isScrapingActive && (
        <div className="bg-dark-bg-olo-secondary rounded-2xl p-6 border border-olo-primary/50">
          <div className="flex items-center space-x-3">
            <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-olo-primary"></div>
            <span className="text-olo-primary font-medium">{currentStep || 'Scraping in progress...'}</span>
          </div>
        </div>
      )}
    </div>
